      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {!user ? (
          <button
            ...
            className="cursor-pointer px-8 py-2 bg-primary hover:bg-priimary-dull transition text-white rounded-full"
          >
            Login
          </button>
        ) : (
        ...
        >
          ...
          {!user ? (
            <button
              ...
              className="cursor-pointer px-6 py-2 mt-2 bg-primary hover:bg-primay-dull transition text-white rounded-full text-sm"
            >
              Login
            </button>
          ) : (
